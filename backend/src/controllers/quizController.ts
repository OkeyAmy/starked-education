 ...
 * Uses AppError for standardized error handling
 */
class QuizController {
  ...
  async createQuiz(req: Request, res: Response): Promise<void> {
    const instructorId = (req as any).user?.id || 'default-instructor';
    ...
    if (response.success) {
      ...
      throw new ValidationError(response.message || 'Failed to create quiz');
    }
  }
  ...
  async getQuizById(req: Request, res: Response): Promise<void> {
    ...
    if (response.success) {
      ...
      throw new NotFoundError('Quiz not found', { quizId: id });
    }
  }
  ...
  async getQuizzes(req: Request, res: Response): Promise<void> {
    ...
    if (response.success) {
      ...
      throw new ValidationError(response.message || 'Failed to retrieve quizzes');
    }
  }
  ...
  async submitQuiz(req: Request, res: Response): Promise<void> {
    ...
    if (response.success) {
      ...
      throw new ValidationError(response.message || 'Quiz submission failed');
    }
  }
  ...
  async getUserSubmission(req: Request, res: Response): Promise<void> {
    ...
    if (response.success) {
      ...
      throw new NotFoundError('Submission not found', { quizId, userId });
    }
  }
  ...
  async getQuizResults(req: Request, res: Response): Promise<void> {
    ...
    if (response.success) {
      ...
      throw new ValidationError(response.message || 'Failed to get quiz results');
    }
  }
  ...
  async getQuizStatistics(req: Request, res: Response): Promise<void> {
    ...
    if (response.success) {
      ...
      throw new NotFoundError('Quiz statistics not found', { quizId });
    }
  }
